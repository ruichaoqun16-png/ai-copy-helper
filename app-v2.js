...
// 真实抓取的小红书内容（自动生成，勿手动修改）
// 规则：多行列表已拆分为单条，超过3行的内容已过滤
const CRAWLED_REAL_CONTENT = [
  {
    "tags": [
      "#文案",
      "#小红书热门",
    ...
    "_crawled": true,
    "_likes": 62347,
    "_originalUrl": "https://www.xiaohongshu.com/explore/6713ba6c000000001402c45b?xsec_token=ABiOR5J8IuS84WSjPiZ8rVvLt7VSwsWLUkdVQ0ACcjk98=",
    "_author": "念安"
  },
  {
    "tags": [
    ...
    "text": "欢迎大家多多点赞收藏关注，以后会更新更多与诗词相关的内容",
    "meta": "5.6w赞",
    "theme": "文案",
    "src": "xhs",
    "timeFit": [
    ...
    "_crawled": true,
    "_likes": 55954,
    "_originalUrl": "https://www.xiaohongshu.com/explore/66168f49000000001a0173ba?xsec_token=ABIpQptwipIzMOZy9TnV3bFaMNaPJKhjokMkB0qXD8COo=",
    "_author": "柳叶笺"
  },
  {
    "tags": [
    ...
    "_crawled": true,
    "_likes": 33136,
    "_originalUrl": "https://www.xiaohongshu.com/explore/683bbaeb000000001200247b?xsec_token=ABd-5jCHhDrhn5DMiIPKyymg-VdttYC6sZJ3cmIYIsQ94=",
    "_author": "简单w33"
  },
  {
    "tags": [
  ...
  },
  {
    ...
    "_crawled": true,
    "_likes": 31069,
    "_originalUrl": "https://www.xiaohongshu.com/explore/67e161ec000000001201f618?xsec_token=ABylftaVbwfd9ORIBL13Aomi4lK_JfAobIgpYW-t83a6Q=",
    "_author": "絕情💤"
  },
  {
    "tags": [
  ...
  },
  {
    ...
    "text": "分享很喜欢的一句∶落下的花瓣似乎也不是结局，而是春天的开始",
    "meta": "3.0w赞",
    "theme": "朋友圈文案",
    "src": "xhs",
    "timeFit": [
    ...
    "_crawled": true,
    "_likes": 30377,
    "_originalUrl": "https://www.xiaohongshu.com/explore/699c3e38000000001d026ccb?xsec_token=ABqt8eCLj3_hM4Euhl4gTFOGqdIgekItvwx3sKtzVtCNE=",
    "_author": "勇气"
  },
  {
    "tags": [
    ...
    "_crawled": true,
    "_likes": 48134,
    "_originalUrl": "https://www.xiaohongshu.com/explore/67ceac9e0000000029038cd3?xsec_token=ABvnUCVS-yTXIAmvDhwxFGbHIJ9QXcBlcitlE6tV_n38I=",
    "_author": "咩咩"
  },
  {
    "tags": [
  ...
  },
  {
    ...
    "_crawled": true,
    "_likes": 45311,
    "_originalUrl": "https://www.xiaohongshu.com/explore/686012db000000002201f528?xsec_token=ABwiGFNob4Kt1gsx-5gtxbXtihTd3Z6K3GZ8sbd_JsLq0=",
    "_author": "云舟遥"
  },
  {
    "tags": [
    ...
    "text": "✨matters not what someone is bornbut what the\nygrow to be.",
    "meta": "3.4w赞",
    "theme": "金句",
    "src": "xhs",
    "timeFit": [
    ...
    "_crawled": true,
    "_likes": 34476,
    "_originalUrl": "https://www.xiaohongshu.com/explore/667e073d000000001f00590f?xsec_token=AB7DVNdAcscMOKdJ4JB56ioYkUIeGedqO2M0OoplCfyxs=",
    "_author": "网感女神bot"
  },
  {
    "tags": [
  ...
  },
  {
    ...
    "text": "✨一个人的出生并不重要，重要的是他长大之后会变得怎么样。",
    "meta": "3.4w赞",
    "theme": "金句",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "✨Time will not slow down when something unpleas  ant lies ahead.",
    "meta": "3.4w赞",
    "theme": "金句",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "✨We've all got both light and darkness inside us.Wh at matters is the part we choose to act on That's wh owe really are.",
    "meta": "3.4w赞",
    "theme": "金句",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "✨每个人心中都有阳光和阴暗的一面。重要的是我们选择成为什么，那才是真正的我们。",
    "meta": "3.4w赞",
    "theme": "金句",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "✨Working hard is important.But there is something that matters even morebelievingin yourself.",
    "meta": "3.4w赞",
    "theme": "金句",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "✨如果你想知道一个人到底怎么样，那就好好看看他是怎么对待比他卑微的物种的，而非和他平等的人。",
    "meta": "3.4w赞",
    "theme": "金句",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "✨It takes a great deal of courage to stand up to you r enemies, but a great deal more to stand up to yourf riends.",
    "meta": "3.4w赞",
    "theme": "金句",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "✨要挺身而出对抗敌人的确需要很大的勇气，但要挺身而出反抗朋友却需要更大的勇气。",
    "meta": "3.4w赞",
    "theme": "金句",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "✨It is not our abilities that show what we trulyareit is our choices.",
    "meta": "3.4w赞",
    "theme": "金句",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "✨决定我们成为什么样人的，不是我们的能力，而是我们的选择。",
    "meta": "3.4w赞",
    "theme": "金句",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "✨The teuth, it is a beautiful and terrible thing ands hould therefore be treated with great caution.",
    "meta": "3.4w赞",
    "theme": "金句",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "✨真相，这是一种美丽而可怕的东西，需要格外谨慎地对待。",
    "meta": "3.4w赞",
    "theme": "金句",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "_crawled": true,
    "_likes": 43218,
    "_originalUrl": "https://www.xiaohongshu.com/explore/63db102a0000000018012eb8?xsec_token=AB1WyXRz-V31v0ZMDodsvR9yqdFr5lfNzppqWeglI6haU=",
    "_author": "煎bingo子🌯"
  },
  {
    "tags": [
    ...
    "text": "🔆\nᴹᵃʸ ᵃˡˡ ᵍᵒᵒᵈ ᵐᵒʳⁿⁱⁿᵍ ᵇᵉ ᵃⁿˢʷᵉʳᵉᵈ.\n愿所有的早安都有回应。",
    "meta": "1.1w赞",
    "theme": "早安文案",
    "src": "xhs",
    "timeFit": [
    ...
    "_crawled": true,
    "_likes": 11351,
    "_originalUrl": "https://www.xiaohongshu.com/explore/5ec9cbb2000000000101db35?xsec_token=ABDz6fiqjO-0XB8M5piDR3xmzvd4N7tAt2HmOo_TSPb3U=",
    "_author": "让我睡一会"
  },
  {
    "tags": [
  ...
  },
  {
    ...
    "_crawled": true,
    "_likes": 8493,
    "_originalUrl": "https://www.xiaohongshu.com/explore/67be9d270000000007036bd7?xsec_token=AB-qgu8Mih-hbl8oc-Uhrt9_ntRtJtJY3kHkYgH5m_8Jw=",
    "_author": "伤心小椰子."
  },
  {
    "tags": [
  ...
  },
  {
    ...
    "text": "早啊 新的一天你再继续努努力吧争取早日拿下姐让姐狠狠疼你",
    "meta": "8.5k赞",
    "theme": "早安文案",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "早上好啊哥哥要玩Cosplay吗你来cos 我工作我去 play",
    "meta": "8.5k赞",
    "theme": "早安文案",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "原来人和动物是能共情的我开始理解鸡早早醒来然后开始尖叫",
    "meta": "8.5k赞",
    "theme": "早安文案",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "停车)(低调的按了按劳斯莱斯的喇叭)(车窗降下来)(咬着玫瑰花)(凹造型)(正准备开口)(隔壁交警大队说我停车占道)(充耳不闻)(带上墨镜)(播凤凰传奇)(薄唇微动)帅哥你好，早安",
    "meta": "8.5k赞",
    "theme": "早安文案",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "_crawled": true,
    "_likes": 25075,
    "_originalUrl": "https://www.xiaohongshu.com/explore/613c7676000000000102e27a?xsec_token=ABDGq4VTASxmH3YilekdaIf5R2AzRIoIJ4fVc2JSFpGXw=",
    "_author": "当当网"
  },
  {
    "tags": [
    ...
    "_crawled": true,
    "_likes": 132353,
    "_originalUrl": "https://www.xiaohongshu.com/explore/68762fc7000000001002769b?xsec_token=ABZISSkGUgw_AMm4P1bXH40920xdsJmvB_nvKwDp5zjvs=",
    "_author": "祝月"
  },
  {
    "tags": [
    ...
    "_crawled": true,
    "_likes": 53962,
    "_originalUrl": "https://www.xiaohongshu.com/explore/69a6972b000000001a0252f4?xsec_token=AB9cP4UQSB7N7xxjf3ZCiZ6lSHx5WYWfpCbm6s89fMQXM=",
    "_author": "春日诗"
  },
  {
    "tags": [
    ...
    "_crawled": true,
    "_likes": 59673,
    "_originalUrl": "https://www.xiaohongshu.com/explore/65cf04b60000000007006a69?xsec_token=ABx0BYOYPD8yxa5SnnMEVYhnIJLWsbLO3Vexp1lriK-bA=",
    "_author": "小熊手写-"
  },
  {
    "tags": [
  ...
  },
  {
    ...
    "text": "-\n“安全感，是一种自我肯定，对生命与潜能的肯定，没有自我肯定，就没有自爱，没有自爱，就无法爱人。”",
    "meta": "6.0w赞",
    "theme": "励志文案",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "-\n“白天行至黄昏，夜晚仰望星辰，追寻山河烟火，亲厚挚爱亲人。”/《偷诗歌的人》",
    "meta": "6.0w赞",
    "theme": "励志文案",
    "src": "xhs",
    "timeFit": [
  ...
  },
  {
    ...
    "text": "The remaining words will be left for the height of summer.",
    "meta": "3.9w赞",
    "theme": "励志文案",
    "src": "xhs",
    "timeFit": [
    ...
    "_crawled": true,
    "_likes": 38956,
    "_originalUrl": "https://www.xiaohongshu.com/explore/6676e5d7000000001f005187?xsec_token=ABUIeoICYOoRwPCDKL3Mp9xIT-6ZLGW_SpKEOEof2te0U=",
    "_author": "小安学姐"
  }
];
...
// 判断是否是编号列表（如 1."xxx" 2."xxx"）
function isNumberedList(text) {
  const lines = text.split('\n').filter(l => l.trim());
  if (lines.length < 3) return false;
  let numbered = 0;
  for (const line of lines) {
    if (/^\d+[\.\、．\）\)]/.test(line.trim())) numbered++;
  }
  return numbered >= 3 && numbered / lines.length >= 0.5;
}
...
function pickOneLine(text) {
  ...
  for (const line of lines) {
    ...
    if (cleaned.length >= 4) quotes.push(cleaned);
  }
  return quotes.length > 0 ? quotes[Math.floor(Math.random() * quotes.length)] : null;
}

// 预处理单条内容：超过3行的返回null，列表类的随机摘录一句
function preprocessContent(item) {
  if (!item || !item.text) return item;
  const text = item.text;
  // 如果是编号列表，随机摘录一句
  if (isNumberedList(text)) {
    const one = pickOneLine(text);
    if (one) return { ...item, text: one };
    return null;
  }
  // 超过3行不展示
  if (countTextLines(text) > 3) return null;
  return item;
}

// 智能标签渲染：去重后，如果第3个标签太长（>10字符）就只显示2个
function renderTags(tags) {
  ...
  let showTags = unique;
  if (unique.length >= 3) {
    const thirdTag = unique[2];
    // 如果第三个标签超过10个字符，减少到2个
    if (thirdTag.length > 10) {
      showTags = unique.slice(0, 2);
    }
  }
  return showTags.map((t, ti) =>
    ti < 2 ? `<span class="pop-tag">${t}</span>` : `<span class="pop-tag pop-tag-ai">${t}</span>`
  ).join('');
}
...
// ========== 推荐版块数据 ==========
const HOT_TOPICS = [
  { title: '#高质量文案', heat: '12.5w赞', matchTags: ['#高质量文案','#金句'], matchThemes: ['高质量文案','金句','文案'], matchText: ['高质量','金句'], src: 'xhs', timeFit: ['any'] },
  { title: '#朋友圈文案', heat: '10.8w赞', matchTags: ['#朋友圈文案','#发圈'], matchThemes: ['朋友圈文案'], matchText: ['朋友圈'], src: 'xhs', timeFit: ['any'] },
  { title: '#网络流行语', heat: '11.2w赞', matchTags: ['#网络流行语','#热梗','#网络热梗'], matchThemes: ['热梗','有梗'], matchText: ['流行语','热梗'], src: 'weibo', timeFit: ['any'] },
  { title: '#早安文案', heat: '9.3w赞', matchTags: ['#早安','#早安文案'], matchThemes: ['早安','早安文案'], matchText: ['早安'], src: 'xhs', timeFit: ['morning'] },
  { title: '#晚安文案', heat: '8.7w赞', matchTags: ['#晚安','#晚安文案'], matchThemes: ['晚安','晚安文案'], matchText: ['晚安'], src: 'xhs', timeFit: ['latenight','evening'] },
  { title: '#MBTI文案', heat: '7.9w赞', matchTags: ['#MBTI','#MBTI语录','#mbti专属语录'], matchThemes: ['MBTI'], matchText: ['MBTI'], src: 'xhs', timeFit: ['any'] },
  { title: '#十二星座文案', heat: '6.5w赞', matchTags: ['#星座','#星座文案'], matchThemes: ['星座'], matchText: ['星座'], src: 'xhs', timeFit: ['any'] },
  { title: '#好运文案', heat: '7.6w赞', matchTags: ['#好运','#好运金句','#旺自己'], matchThemes: ['好运'], matchText: ['好运','旺自己'], src: 'xhs', timeFit: ['morning','any'] },
  { title: '#表白文案', heat: '6.2w赞', matchTags: ['#表白','#恋爱','#恋爱撩人'], matchThemes: ['恋爱','恋爱日常','想念'], matchText: ['表白','想念'], src: 'xhs', timeFit: ['evening','latenight'] },
  { title: '#彩虹屁', heat: '5.8w赞', matchTags: ['#彩虹屁','#夸夸','#满分谢词'], matchThemes: ['彩虹屁','感谢'], matchText: ['彩虹屁','夸夸'], src: 'xhs', timeFit: ['any'] },
  { title: '#优雅怼人', heat: '6.9w赞', matchTags: ['#优雅怼人','#高情商拒绝'], matchThemes: ['怼人','拒绝'], matchText: ['怼人'], src: 'weibo', timeFit: ['any'] },
  { title: '#INS文案', heat: '5.4w赞', matchTags: ['#INS文案','#PLOG文案','#ins金句'], matchThemes: ['ins','PLOG'], matchText: ['INS','PLOG'], src: 'xhs', timeFit: ['any'] },
  { title: '#旅行文案', heat: '7.2w赞', matchTags: ['#旅行文案','#旅行配文'], matchThemes: ['旅行'], matchText: ['旅行'], src: 'xhs', timeFit: ['weekend','daytime'] },
  { title: '#晒美食文案', heat: '6.1w赞', matchTags: ['#美食文案','#美食配文'], matchThemes: ['美食'], matchText: ['美食'], src: 'xhs', timeFit: ['noon','evening'] },
  { title: '#emoji颜文字', heat: '4.6w赞', matchTags: ['#颜文字','#emoji','#梦幻emoji'], matchThemes: ['emoji'], matchText: ['颜文字','emoji'], src: 'xhs', timeFit: ['any'] },
  { title: '#春日碎片', heat: '5.1w赞', matchTags: ['#春日碎片'], matchThemes: ['春日'], matchText: ['春日','碎片'], src: 'xhs', timeFit: ['daytime','weekend'] },
  { title: '#生日祝福', heat: '5.9w赞', matchTags: ['#生日祝福','#生日快乐'], matchThemes: ['生日祝福','生日'], matchText: ['生日','祝福'], src: 'xhs', timeFit: ['any'] },
  { title: '#安慰鼓励', heat: '6.3w赞', matchTags: ['#安慰鼓励','#安慰'], matchThemes: ['安慰','励志文案'], matchText: ['安慰','鼓励'], src: 'xhs', timeFit: ['any'] },
  { title: '#经典语录', heat: '9.1w赞', matchTags: ['#经典语录','#金句','#每日金句'], matchThemes: ['经典语录','金句'], matchText: ['经典','语录'], src: 'xhs', timeFit: ['any'] },
  { title: '#晒娃文案', heat: '4.8w赞', matchTags: ['#晒娃','#亲子','#萌娃配文'], matchThemes: ['萌娃','恋爱日常'], matchText: ['晒娃','萌娃'], src: 'xhs', timeFit: ['any'] },
  { title: '#搞笑文案', heat: '6.6w赞', matchTags: ['#有梗文案','#已读乱回','#发疯文学','#显眼包文案'], matchThemes: ['有梗','乱回','发疯','显眼包'], matchText: ['搞笑','发疯'], src: 'xhs', timeFit: ['any'] },
  { title: '#打工人文学', heat: '5.5w赞', matchTags: ['#打工人文学','#职场生存'], matchThemes: ['职场','打工人'], matchText: ['打工人','职场'], src: 'xhs', timeFit: ['workday','daytime'] },
  { title: '#emo文案', heat: '5.2w赞', matchTags: ['#emo文案','#励志文案'], matchThemes: ['emo文案','励志文案'], matchText: ['emo'], src: 'xhs', timeFit: ['latenight','evening'] },
];

const REC_CATEGORIES = [
  { icon: '✍️', label: '高质量文案', matchTags: ['#高质量文案','#金句'], matchThemes: ['高质量文案','金句','文案'], timeFit: ['any'] },
  { icon: '📱', label: '朋友圈文案', matchTags: ['#朋友圈文案','#发圈'], matchThemes: ['朋友圈文案'], timeFit: ['any'] },
  { icon: '📝', label: '经典语录', matchTags: ['#经典语录','#金句','#每日金句'], matchThemes: ['经典语录','金句'], timeFit: ['any'] },
  { icon: '💬', label: '网络热梗', matchTags: ['#网络流行语','#热梗','#网络热梗'], matchThemes: ['热梗','有梗'], timeFit: ['any'] },
  { icon: '✈️', label: '旅行文案', matchTags: ['#旅行配文','#旅行文案'], matchThemes: ['旅行'], timeFit: ['weekend','daytime'] },
  { icon: '🍜', label: '晒美食', matchTags: ['#美食文案','#美食配文'], matchThemes: ['美食'], timeFit: ['noon','evening'] },
  { icon: '☀️', label: '早安', matchTags: ['#早安','#早安文案'], matchThemes: ['早安','早安文案'], timeFit: ['morning'] },
  { icon: '🌙', label: '晚安', matchTags: ['#晚安','#晚安文案'], matchThemes: ['晚安','晚安文案'], timeFit: ['latenight','evening'] },
  { icon: '💕', label: '表白/恋爱', matchTags: ['#表白','#恋爱','#恋爱撩人'], matchThemes: ['恋爱','恋爱日常','想念'], timeFit: ['evening','latenight'] },
  { icon: '🙏', label: '高情商感谢', matchTags: ['#高情商','#感谢','#满分谢词'], matchThemes: ['感谢'], timeFit: ['any'] },
  { icon: '💗', label: '表达想念', matchTags: ['#想念','#想念的话'], matchThemes: ['想念'], timeFit: ['evening','latenight'] },
  { icon: '🌈', label: '彩虹屁', matchTags: ['#彩虹屁','#夸夸'], matchThemes: ['彩虹屁'], timeFit: ['any'] },
  { icon: '🎂', label: '生日祝福', matchTags: ['#生日祝福','#生日快乐'], matchThemes: ['生日祝福','生日'], timeFit: ['any'] },
  { icon: '🤗', label: '安慰鼓励', matchTags: ['#安慰','#安慰鼓励','#励志文案'], matchThemes: ['安慰','励志文案'], timeFit: ['any'] },
  { icon: '😈', label: '优雅怼人', matchTags: ['#优雅怼人','#高情商拒绝'], matchThemes: ['怼人','拒绝'], timeFit: ['any'] },
  { icon: '📸', label: 'PLOG/INS', matchTags: ['#PLOG文案','#INS文案','#ins金句'], matchThemes: ['ins','PLOG'], timeFit: ['any'] },
  { icon: '👶', label: '晒娃', matchTags: ['#晒娃','#萌娃配文'], matchThemes: ['萌娃'], timeFit: ['any'] },
  { icon: '🌸', label: '春日碎片', matchTags: ['#春日碎片'], matchThemes: ['春日'], timeFit: ['any'] },
  { icon: '😜', label: 'emoji颜文字', matchTags: ['#颜文字','#emoji','#梦幻emoji'], matchThemes: ['emoji'], timeFit: ['any'] },
  { icon: '🍀', label: '好运文案', matchTags: ['#好运','#好运金句','#旺自己'], matchThemes: ['好运'], timeFit: ['morning','any'] },
  { icon: '♈', label: '星座文案', matchTags: ['#星座','#星座文案'], matchThemes: ['星座'], timeFit: ['any'] },
  { icon: '🧩', label: 'MBTI文案', matchTags: ['#MBTI','#MBTI语录','#mbti专属语录'], matchThemes: ['MBTI'], timeFit: ['any'] },
  { icon: '💼', label: '职场/打工人', matchTags: ['#职场','#打工人','#打工人文学','#职场生存'], matchThemes: ['职场','打工人'], timeFit: ['workday','daytime'] },
  { icon: '🤪', label: '搞笑文案', matchTags: ['#有梗文案','#已读乱回','#发疯文学','#显眼包文案'], matchThemes: ['有梗','乱回','发疯','显眼包'], timeFit: ['any'] },
  { icon: '💔', label: 'emo文案', matchTags: ['#emo文案','#励志文案'], matchThemes: ['emo文案','励志文案'], timeFit: ['latenight','evening'] },
  { icon: '🔥', label: '破冰开场', matchTags: ['#破冰开场'], matchThemes: ['破冰'], timeFit: ['any'] },
];
...
function buildShuffledCopies() {
  // 1. 合并所有非常用库内容，预处理：超3行过滤、列表拆分
  const crawled = [...ALL_POPULAR_COPIES_HOT, ...ALL_POPULAR_COPIES_NORMAL]
    .map(c => preprocessContent({...c}))
    .filter(c => c !== null);
  
  // 2. 获取常用库内容（如果已加载），同样预处理
...
// theme别名映射：数据中的theme -> CLONE_TEMPLATES中的key
const THEME_ALIAS = {
  'emoji':'颜文字','emo文案':'emo','励志文案':'励志','早安文案':'早安','晚安文案':'晚安',
  '恋爱日常':'恋爱','想念':'恋爱','有梗':'搞笑','乱回':'搞笑','发疯':'搞笑','显眼包':'搞笑',
  '热梗':'搞笑','怼人':'搞笑','拒绝':'搞笑','打工人':'职场','破冰':'搞笑',
  '金句':'哲思','高质量文案':'哲思','经典语录':'哲思','文案':'哲思',
  '安慰':'治愈','好运':'励志','ins':'恋爱','PLOG':'恋爱','感谢':'治愈',
  '彩虹屁':'治愈','生日祝福':'治愈','生日':'治愈',
  '春日':'治愈','萌娃':'恋爱','星座':'MBTI','精选':'哲思',
};
// 关联theme组：互相之间可以匹配
const RELATED_THEMES = [
  ...
  ['早安','早安文案'],['晚安','晚安文案'],
  ['恋爱','恋爱日常','想念'],
  ['搞笑','有梗','乱回','发疯','显眼包','热梗','怼人','拒绝','破冰'],
  ['职场','打工人'],
  ['emo','emo文案','励志文案','安慰','治愈'],
  ['金句','高质量文案','经典语录','文案','哲思','格局'],
  ['MBTI','星座'],
  ['ins','PLOG','旅行','春日'],
  ['生日','生日祝福'],
  ['美食'],['萌娃'],['好运'],['彩虹屁','感谢'],
...
function getRelatedThemes(theme) {
  const res = new Set([theme]);
  for (const group of RELATED_THEMES) {
    if (group.includes(theme)) { group.forEach(t => res.add(t)); }
  }
  return res;
}
...
function generateClones(item) {
  ...
  const allC = [...COMMON_LIB_SEEDS, ...CRAWLED_REAL_CONTENT];
  const relatedThemes = getRelatedThemes(theme);

  // 第1优先：从全部数据中找同theme的内容
  const sameTheme = allC.filter(c => c.text !== itemText && c.theme === theme)
    .sort(() => Math.random() - .5);
  // 第2优先：从全部数据中找关联theme的内容
  const relatedTheme = allC.filter(c => c.text !== itemText && c.theme !== theme && relatedThemes.has(c.theme))
    .sort(() => Math.random() - .5);
  // 第3优先：从全部数据中找同tag的内容
  const sameTag = allC.filter(c => c.text !== itemText && !relatedThemes.has(c.theme) && c.tags && item.tags && item.tags.some(t => c.tags.includes(t)))
    .sort(() => Math.random() - .5);
  // 第4优先：从CLONE_TEMPLATES中找（带别名映射）
  const templateKey = THEME_ALIAS[theme] || theme;
  const tmpl = (CLONE_TEMPLATES[templateKey] || []).filter(t => t !== itemText)
    .sort(() => Math.random() - .5);

  // 按优先级合并去重
  const pool = [...sameTheme.map(c=>c.text), ...relatedTheme.map(c=>c.text), ...sameTag.map(c=>c.text), ...tmpl];
  const seen = new Set([itemText]);
  const results = [];
  for (const t of pool) {
...
function matchCopies(mTags,mThemes,mText){
  ...
  const all=[...ALL_POPULAR_COPIES_HOT,...ALL_POPULAR_COPIES_NORMAL,...libItems]
    .map(c => preprocessContent({...c})).filter(c => c !== null);
  const seen=new Set(),results=[];
  for(const c of all){
    const k=c.text.slice(0,50);if(seen.has(k))continue;
    let match=false;
    // tag匹配：用精确比较（去掉#后完全相等），而非子串包含，避免 #emoji 误匹配 #emo
    if(mTags&&mTags.length&&c.tags){
      for(const mt of mTags){
        const mtClean=mt.toLowerCase().replace('#','');
        if(c.tags.some(t=>{
          const tClean=t.toLowerCase().replace('#','');
          // 精确匹配：标签去#后完全相等，或者标签以"搜索词+"开头（如"emo文案"匹配"emo"）但不允许"emoji"匹配"emo"
          return tClean===mtClean || tClean.startsWith(mtClean+'·') || tClean.startsWith(mtClean+'｜') || tClean.startsWith(mtClean+' ');
        })){match=true;break;}
      }
    }
...
function renderFilterPage(){
  ...
  document.getElementById('filterList').innerHTML=items.map((p,idx)=>{
    const uid=`f-${filterPage}-${idx}`,tagsH=renderTags(p.tags);
...
// ========== 内容库持久化（localStorage）==========
const CONTENT_DB_KEY = 'ai_copywriter_content_db_v6_clean';
const CRAWL_LOG_KEY = 'ai_copywriter_crawl_logs_v6_clean';
...
// 真实抓取数据池（由 crawled_entries.js 提供 CRAWLED_REAL_CONTENT）
let _crawledRealPool = typeof CRAWLED_REAL_CONTENT !== 'undefined' ? [...CRAWLED_REAL_CONTENT] : [];
let _crawledRealUsed = new Set();
...
function simulateCrawlV4() {
  ...
  let totalCount = 0;
  let totalLikes = 0;
  const perSourceCount = { xiaohongshu: 0 };

  // 使用真实抓取数据
  if (_crawledRealPool.length > 0) {
    // 随机打乱并选取一批（每次3-8条）
    const available = _crawledRealPool.filter(item => !_crawledRealUsed.has(item.text) && !existTexts.has(item.text));
    const batchSize = Math.min(Math.floor(Math.random() * 6) + 3, available.length);
    const batch = [...available].sort(() => Math.random() - .5).slice(0, batchSize);

    for (const item of batch) {
      // 预处理：超3行过滤、列表拆分
      const processed = preprocessContent(item);
      if (!processed) continue;

      _crawledRealUsed.add(item.text);
      existTexts.add(processed.text);

      const newItem = {
        tags: deduplicateTags(processed.tags || [`#${processed.theme}`, '#小红书热门', '适合发圈｜走心好文']),
        text: processed.text,
        meta: processed.meta || `${(processed._likes/10000).toFixed(1)}w赞`,
        theme: processed.theme || '文案',
        src: 'xhs',
        updatedAt: dateStr,
        timeFit: processed.timeFit || ['any'],
        _crawled: true,
        _likes: processed._likes || 0,
        _crawlTime: now.getTime(),
        _originalUrl: processed._originalUrl || '',
        _author: processed._author || '',
      };
      ALL_POPULAR_COPIES_NORMAL.push(newItem);
      totalCount++;
      totalLikes += (processed._likes || 0);
      perSourceCount.xiaohongshu++;
    }

    // 如果真实数据全部用完，重置池子
    if (_crawledRealUsed.size >= _crawledRealPool.length) {
      _crawledRealUsed.clear();
    }
  }
  ...
  toast(`✅ 自动抓取完成！新增 ${totalCount} 条真实内容`);
}
